...
namespace MinimalApiPeliculas.EndPoints
{
    public static class PeliculasEndPoints
    {
        ...
        static async Task<Created<PeliculaDTO>> Crear([FromForm] CrearPeliculaDTO crearPeliculaDTO, IRepositoryPeliculas repositorio,
        ...
        static async Task<Ok<List<PeliculaDTO>>>Obtener(IRepositoryPeliculas repositorio, IMapper mapper, int pagina=1,int recordsPagina = 10)
        {
        ...
        static async Task<Results<Ok<PeliculaDTO>,NotFound>> ObtenerPorId(int id, IRepositoryPeliculas repositorio, IMapper mapper)
        {
        ...
        static async Task<Results<NoContent, NotFound>>Actualizar(int id,
            [FromForm]CrearPeliculaDTO crearPeliculaDTO, IRepositoryPeliculas repositorio,
        ...
        static async Task <Results<NoContent,NotFound>> Borrar(int id, IRepositoryPeliculas repositorio, 
        ...
        static async Task<Results<NoContent,NotFound, BadRequest<string>>> AsignarGeneros(int id, List<int>generosIds, IRepositoryPeliculas repositorioPeliculas, 
            IRepositoryGenero repositorioGeneros)
        {
        ...
        static async Task<Results<NotFound,NoContent,BadRequest<string>>> AsignarActores(int id,
            List<AsignarActorPeliculaDTO> actoresDTO, IRepositoryPeliculas repositorioPeliculas, IRepositoryActores repositorioActores
            , IMapper mapper)
        {
            if(! await repositorioPeliculas.Existe(id))
            {
